...
소스 5곳을 실제로 재봤다(측정 방법: RSS를 실제로 호출해 건수·최근성을 세고,
최신 기사 1건의 본문을 trafilatura로 뽑아 길이를 잰다).

| 소스 | 24h 이내 건수 | G1(본문 600자 이상) | 채택 여부 |
|---|---|---|---|
| 한국경제 (feed/finance) | 50건 | 통과(1,378자) | ✅ |
| 연합뉴스 경제 | 120건 | 통과(1,069자) | ✅ |
| Investing.com (news_25) | 10건 | 통과(3,264자) | ✅ |
| Yahoo Finance | 50건 중 11건 | 통과(5,400자) | ✅ |
| CNBC Markets | 30건 중 1건 | 통과(7,264자) | ✅ (아래 참고) |
